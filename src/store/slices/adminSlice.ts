...
export const fetchAllBuyers = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>("admin/fetchAllBuyers", async (_, { rejectWithValue }) => {
  try {
...
export const fetchAllMerchants = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>("admin/fetchAllMerchants", async (_, { rejectWithValue }) => {
  try {
...
export const createNewBuyer = createAsyncThunk<
  ...
  CreateBuyerPayload,
  { rejectValue: string }
>("admin/createNewBuyer", async (payload, { rejectWithValue }) => {
  try {
...
export const createNewMerchant = createAsyncThunk<
  ...
  { rejectValue: string }
>("admin/createNewMerchant", async (payload, { rejectWithValue }) => {
  try {
...
export const updateBuyer = createAsyncThunk<
  ...
  UpdateBuyerPayload,
  { rejectValue: string }
>("admin/updateBuyer", async (payload, { rejectWithValue }) => {
  try {
...
export const updateMerchant = createAsyncThunk<
  ...
  { rejectValue: string }
>("admin/updateMerchant", async (payload, { rejectWithValue }) => {
  try {
    const { id, ...body } = payload;
...
export const fetchAllRoles = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>("admin/fetchAllRoles", async (_, { rejectWithValue }) => {
  try {
...
export const createNewRole = createAsyncThunk<
  ...
  CreateRolePayload,
  { rejectValue: string }
>("admin/createNewRole", async (payload, { rejectWithValue }) => {
  try {
...
export const updateRole = createAsyncThunk<
  ...
  UpdateRolePayload,
  { rejectValue: string }
>("admin/updateRole", async (payload, { rejectWithValue }) => {
  try {
    const { id, ...body } = payload;
...
export const deleteRole = createAsyncThunk<
  DeleteRoleResponse & { id: number },
  number,
  { rejectValue: string }
>("admin/deleteRole", async (id, { rejectWithValue }) => {
  try {
...
export const fetchAllAdminUsers = createAsyncThunk<
  ...
  void,
  { rejectValue: string }
>("admin/fetchAllAdminUsers", async (_, { rejectWithValue }) => {
  try {
...
export const fetchAllPaymentPlans = createAsyncThunk<
  PaymentPlanListResponse,
  void,
  { rejectValue: string }
>("admin/fetchAllPaymentPlans", async (_, { rejectWithValue }) => {
  try {
...
export const createPaymentPlan = createAsyncThunk<
  ...
  { rejectValue: string }
>("admin/createPaymentPlan", async (payload, { rejectWithValue }) => {
  try {
...
export const updatePaymentPlan = createAsyncThunk<
  ...
  { rejectValue: string }
>("admin/updatePaymentPlan", async (payload, { rejectWithValue }) => {
  try {
    const { id, ...body } = payload;
...
export const deletePaymentPlan = createAsyncThunk<
  DeletePaymentPlanResponse & { id: number },
  number,
  { rejectValue: string }
>("admin/deletePaymentPlan", async (id, { rejectWithValue }) => {
  try {
    const res = await apiFetch(`/api/payment-plan/delete/${id}`, {
      method: "DELETE",
    });
    const data = await res.json();
    if (!res.ok)
...
export const loginAdmin = createAsyncThunk<
  ...
  LoginPayload,
  { rejectValue: string }
>("admin/loginAdmin", async (payload, { rejectWithValue }) => {
  try {
...
export const verifyOtpForLogin = createAsyncThunk<
  LoginResponse,
  { email: string; role: string; code: string },
  { rejectValue: string }
>("admin/verifyOtpForLogin", async (payload, { rejectWithValue }) => {
  try {
...
export const deleteDocument = createAsyncThunk<
  ...
  number,
  { rejectValue: string }
>("admin/deleteDocument", async (id, { rejectWithValue }) => {
  try {
    const res = await apiFetch(`/api/document/delete/${id}`, {
      method: "DELETE",
    });
    const data = await res.json();
...
export const emailOtpSendAndVerify = createAsyncThunk<
  ...
  EmailOtpPayload,
  { rejectValue: string }
>("auth/emailOtpSendAndVerify", async (payload, { rejectWithValue }) => {
  try {
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(fetchAllBuyers.rejected, (state, action) => {
        state.buyersLoading = false;
        state.buyersError = action.payload ?? "Something went wrong";
      });
    ...
    // ── Create Buyer ──
    builder
      .addCase(createNewBuyer.pending, (state) => {
        state.actionLoading = true;
        state.actionError = null;
      })
      .addCase(createNewBuyer.fulfilled, (state) => {
        state.actionLoading = false;
      })
      .addCase(createNewBuyer.rejected, (state, action) => {
        state.actionLoading = false;
    ...
    // ── Create Merchant ──
    builder
      .addCase(createNewMerchant.pending, (state) => {
        state.actionLoading = true;
        state.actionError = null;
      })
      .addCase(createNewMerchant.fulfilled, (state) => {
        state.actionLoading = false;
      })
      .addCase(createNewMerchant.rejected, (state, action) => {
        state.actionLoading = false;
        state.actionError = action.payload ?? "Something went wrong";
      });
    ...
    builder
      ...
      .addCase(updateBuyer.fulfilled, (state, action) => {
        state.actionLoading = false;
        const idx = state.buyers.findIndex(
          (b) => b.id === action.payload.buyer.id,
        );
    ...
    builder
      ...
      .addCase(updateMerchant.fulfilled, (state, action) => {
        ...
        const idx = state.merchants.findIndex(
          (m) => m.id === action.payload.merchant.id,
        );
    ...
    builder
      ...
      .addCase(fetchAllRoles.rejected, (state, action) => {
        state.rolesLoading = false;
        state.rolesError = action.payload ?? "Something went wrong";
      });
    ...
    // Payment Plan
    builder
      .addCase(fetchAllPaymentPlans.pending, (state) => {
        state.paymentPlanLoading = true;
        state.paymentPlanError = null;
      })
      .addCase(fetchAllPaymentPlans.fulfilled, (state, action) => {
        state.paymentPlanLoading = false;
        state.paymentPlan = action.payload.paymentPlans;
      })
      .addCase(fetchAllPaymentPlans.rejected, (state, action) => {
        state.paymentPlanLoading = false;
        state.paymentPlanError = action.payload ?? "Something went wrong";
      });
    ...
    builder
      ...
      .addCase(updatePaymentPlan.fulfilled, (state, action) => {
        state.actionLoading = false;
        const idx = state.paymentPlan.findIndex(
          (p) => p.id === action.payload.paymentPlan.id,
        );
    ...
    builder
      ...
      .addCase(deletePaymentPlan.fulfilled, (state, action) => {
        state.actionLoading = false;
        state.paymentPlan = state.paymentPlan.filter(
...
// ─── Selectors ────────────────────────────────────────────────────────────────
export const selectMerchants = (state: { admin: AdminState }) =>
  state.admin.merchants;
export const selectMerchantsLoading = (state: { admin: AdminState }) =>
  state.admin.merchantsLoading;
export const selectMerchantsError = (state: { admin: AdminState }) =>
  state.admin.merchantsError;

export const selectBuyers = (state: { admin: AdminState }) =>
  state.admin.buyers;
export const selectBuyersLoading = (state: { admin: AdminState }) =>
  state.admin.buyersLoading;
export const selectBuyersError = (state: { admin: AdminState }) =>
  state.admin.buyersError;

export const selectActionLoading = (state: { admin: AdminState }) =>
  state.admin.actionLoading;
export const selectActionError = (state: { admin: AdminState }) =>
  state.admin.actionError;

export const selectRoles = (state: { admin: AdminState }) => state.admin.roles;
export const selectRolesLoading = (state: { admin: AdminState }) =>
  state.admin.rolesLoading;
export const selectRolesError = (state: { admin: AdminState }) =>
  state.admin.rolesError;
...
export const selectUsersError = (state: { admin: AdminState }) =>
  state.admin.usersError;

export const selectPaymentPlan = (state: { admin: AdminState }) =>
  state.admin.paymentPlan;
export const selectPaymentPlanLoading = (state: { admin: AdminState }) =>
  state.admin.paymentPlanLoading;
export const selectPaymentPlanError = (state: { admin: AdminState }) =>
  state.admin.paymentPlanError;

export const selectAuthUser = (state: { admin: AdminState }) =>
  state.admin.authUser;
export const selectAuthLoading = (state: { admin: AdminState }) =>
  state.admin.authLoading;
export const selectAuthError = (state: { admin: AdminState }) =>
  state.admin.authError;
